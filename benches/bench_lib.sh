...
#   PROJECT_ROOT            absolute path to the pgfusion crate root
#   PG_ARROW_ROOT           absolute path to the pg_arrow crate root
#   CONFIG_FILE             absolute path to pg-test-config.toml
#
